...
def get_processes_info():
    ...
    for process in psutil.process_iter():
        ...
        with process.oneshot():
            ...
            # get priority (lower value means a more prioritized process)
            try:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-c",
        "--columns",
        help="""Columns to show, available are name,create_time,cores,cpu_usage,status,nice,memory_usage,read_bytes,
                write_bytes,n_threads,username.  Default is name,cpu_usage,memory_usage,read_bytes,write_bytes,status,
    ...
    parser.add_argument(
        "--descending", action="store_true", help="Whether to sort in descending order."
    )
    parser.add_argument(
        "-n",
